...
from built_in_functions import print, say, show_modal_alert
...
class Character:
    def __init__(
        ...
        self.mp = initMp
        self.initMp = initMp
        self.img = f"/static/img/characters/{name}-0.webp"
        self.running_time = 0
        self.rotate = rotate
    ...
    def draw(self):
        ...
        character.style.backgroundImage = (
            f'url("/static/img/characters/{self.name}-{self.directions}.webp")'
        )
    ...
    def _turn_left_animation(self, directions):
        ...
        if directions == 3:
            c.style.backgroundImage = f'url("/static/img/characters/{self.name}-0.webp")'
        else:
            c.style.backgroundImage = (
                f'url("/static/img/characters/{self.name}-{directions+1}.webp")'
            )
