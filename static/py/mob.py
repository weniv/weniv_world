...
class Mob:
    def __init__(
        ...
        # self.power = power
        self.hp = initHp
        self.img = f"/static/img/characters/{mob}-0.webp"
        self.running_time = 0
        self.rotate = rotate
    ...
    def draw(self):
        ...
        mob.style.backgroundImage = (
            f'url("/static/img/characters/{self.mob}-{self.directions}.webp")'
        )
    ...
    def _turn_left_animation(self, directions):
        ...
        if directions == 3:
            c.style.backgroundImage = f'url("/static/img/characters/{self.mob}-0.webp")'
        else:
            c.style.backgroundImage = (
                f'url("/static/img/characters/{self.mob}-{directions+1}.webp")'
            )
    ...
    def draw_attack(self, x, y, x2, y2, skill):
        ...
        attack.style.backgroundImage = f'url("/static/img/weapon/{skill}.png")'
